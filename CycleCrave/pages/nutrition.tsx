...
const imageMap = {
  ...
  "../images/egg_yolks.jpg": require("../images/egg_yolks.jpg"),
  "../images/mushrooms.jpg": require("../images/mushrooms.jpg"),
  ...
  "../images/fenugreek_seed.jpg": require("../images/fenugreek_seed.jpg"),
  ...
  "../images/st_john's_wort.jpg": require("../images/st_john's_wort.jpg"),
